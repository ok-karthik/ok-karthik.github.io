        ...
        <header className="mb-12">
          <div className="mb-4 flex items-center justify-between gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 font-mono text-xs text-primary hover:underline bg-primary/10 border border-primary/20 px-3 py-1 rounded-full"
            >
              View on LinkedIn
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold tracking-tight text-foreground text-balance">
            What engineering leaders and teammates say
          </h2>
          <p className="mt-2 text-muted-foreground text-sm md:text-base">
            Direct feedback from engineering managers, architects, and senior peers
          </p>
        </header>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {recommendations.map((rec, index) => (
            <motion.figure
              ...
              className="bg-card/30 backdrop-blur-xl border border-border/60 rounded-3xl p-6 sm:p-7 flex flex-col justify-between hover:border-primary/40 hover:bg-card/40 hover:shadow-xl transition-all"
            >
              <div>
              ...
              <figcaption className="mt-6 pt-4 border-t border-border/40">
                ...
                <div className="font-mono text-[10px] text-primary/80 mt-1">
                  {rec.context}
                </div>
              </figcaption>
            </motion.figure>
