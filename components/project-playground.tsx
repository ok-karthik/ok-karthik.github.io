...
import { Play, RotateCcw, AlertTriangle, ShieldCheck, Zap, Server, Database, Activity, Cpu } from "lucide-react"
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-3">
        ...
        <div className="rounded-lg border border-border bg-muted/40 p-4">
          ...
          <div className="mt-3 space-y-2 font-mono text-micro">
            ...
            <div className="flex items-center justify-between rounded border border-border bg-card p-2">
              <span>Tempo</span>
              <span className="label text-primary">{mode === "error-spike" ? "100% Captured" : "Traces (5%)"}</span>
            </div>
          </div>
        </div>
      </div>
...
/* -------------------------------------------------------------------------- */
/* 2. FinOps Kubernetes Operator Schedule Simulator                          */
/* -------------------------------------------------------------------------- */
    ...
    <div className="glass rounded-xl p-6 sm:p-7">
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-border pb-4">
        ...
        <div className="flex items-center gap-3">
          <span className="font-mono text-small tabular font-semibold text-foreground">
...
/* -------------------------------------------------------------------------- */
/* 3. AI Infrastructure on Amazon EKS GPU Allocator Simulator                 */
/* -------------------------------------------------------------------------- */
          ...
          <div className="space-y-2.5 text-muted-foreground">
            ...
            <div className="flex justify-between border-b border-border pb-1.5">
              ...
              <span className="font-bold text-primary">
                {sharingMode === "time-slice" ? "~$0.22 / hr (for 4 pods)" : "~$0.88 / hr (for 4 pods)"}
              </span>
            </div>
