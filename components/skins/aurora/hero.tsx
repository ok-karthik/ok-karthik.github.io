 ...
 * Bottom: Three floating stat tiles and the quick section jump index.
 */
  ...
  return (
    <section id="top" className="scroll-mt-24">
      <div className="mx-auto max-w-6xl px-6 pb-16 pt-28 md:pt-32">
        ...
        <nav
          aria-label="Sections"
          className="mt-8 overflow-hidden rounded-xl border border-border bg-card/60 backdrop-blur-md"
        >
